...
func SetMemoryConfigGet(c *gin.Context) {
	...
	gsgin.GinResponseSuccess(c, ``, map[string]any{
		...
		`db_path_raw`:                     strings.TrimSpace(component.ConfigViper.GetString(`base.dbPath`)),
		`db_name_raw`:                     strings.TrimSpace(component.ConfigViper.GetString(`base.dbFileName`)),
		...
		`memory_db_path_raw`:              strings.TrimSpace(component.ConfigViper.GetString(`base.memoryDbPath`)),
		`memory_db_name_raw`:              strings.TrimSpace(component.ConfigViper.GetString(`base.memoryDbFileName`)),
