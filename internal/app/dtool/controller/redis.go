...
func RedisAvailableList(c *gin.Context) {
	...
	redisConfigList, redisConfigListErr := common.DbMain.GetAllRedisConfig()
...
func getRedisComponent(c *gin.Context) (map[string]interface{}, *gsdb.GsRedis, error) {
	...
	redisConfig, redisConfigErr := common.DbMain.GetRedisConfig(redisId)
