...
func SmartLinkAdd(c *gin.Context) {
	...
	updateData := gstool.MapTakeKeys(&dataMap, []string{`name`, `smart_link_group_id`, `links`, `open_num`, `open_type`, `process`, `weight`, `is_save_user_data`, `is_combine`, `fix_data_id`})
